        ...
        <div class="card-body">
            ...
            <form action="{{ route('product-add') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="capacity" class="form-control @error('capacity') is-invalid @enderror" id="capacity" placeholder="Enter Capacity" value="{{ old('capacity') }}" required>
                    @error('capacity')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    <label for="sku" class="form-label">Type <code>*</code></label>
                    <input type="text" name="type" class="form-control @error('type') is-invalid @enderror" id="type" placeholder="Enter type" value="{{ old('type') }}" required>
                    @error('type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-3">
                    ...
                    <input type="text" name="voltage" class="form-control @error('voltage') is-invalid @enderror" id="voltage" placeholder="Enter voltage" value="{{ old('voltage') }}" required>
                    @error('vlotage')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
