    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body">
            ...
            <div class="card-title d-flex align-items-center justify-content-between">
                ...
                <div>
                    <a href="{{ route('brands') }}" class="btn btn-primary"><i class="bx bx-list-ol"></i> Brand List</a> 
                </div>
            </div>
            <hr>
            
            <form action="{{ route('brand-update', ['id' => $data->id]) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-3">
                    ...
                    <img src="{{ asset('images/brand/' . $data->image) }}" class="product-img-2" alt="product img" style="margin-right: 8px;">
                </div>
