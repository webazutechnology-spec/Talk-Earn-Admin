        ...
        <div class="card-body">
            ...
            <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Add Net Metering</h5>
                </div>
                <div>
                    <a href="{{ route('netmeterings') }}" class="btn btn-primary"><i class="bx bx-list-ol"></i> Master List</a> 
                </div>
            </div>
            <hr>
            
            <form action="{{ route('netmetering-add') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
