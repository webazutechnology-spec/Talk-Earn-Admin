...
@section('content')
    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body">
            ...
            <form action="{{ route('training-category-update', ['id' => $data->id]) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-3">
                    ...
                    <img src="{{ asset('images/training/category/' . $data->image) }}" class="product-img-2" alt="product img" style="margin-right: 8px;">
                </div>
