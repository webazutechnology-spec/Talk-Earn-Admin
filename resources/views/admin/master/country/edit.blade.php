        ...
        <div class="card-body">
            ...
            <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Update Country</h5>
                </div>
                <div>
            ...
            <hr>
            <form action="{{ route('country-update', ['id' => $data->id]) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="iso3" class="form-control @error('iso3') is-invalid @enderror" placeholder="Enter iso 3" id="iso3" value="{{ old('iso3', $data->iso3) }}">
                    @error('iso3')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="phonecode" class="form-control @error('phonecode') is-invalid @enderror" placeholder="Enter phone code" id="phonecode" value="{{ old('phonecode', $data->phonecode) }}">
                    @error('phonecode')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="capital" class="form-control @error('capital') is-invalid @enderror" placeholder="Enter capital" id="capital" value="{{ old('capital', $data->capital) }}">
                    @error('capital')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="currency" class="form-control @error('currency') is-invalid @enderror" placeholder="Enter currency" id="currency" value="{{ old('currency', $data->currency) }}">
                    @error('currency')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="currency_symbol" class="form-control @error('currency_symbol') is-invalid @enderror" placeholder="Enter currency symbol" id="currency_symbol" value="{{ old('currency_symbol', $data->currency_symbol) }}">
